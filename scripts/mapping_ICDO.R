...
# Custom, generalized parsing functions (wrap PyOBO)

#' Map Terms to Terms of Specified Namespace
#'
#' Map `term` to terms of a specified namespace (e.g. "doid") using PyOBO (and
#' by dependency other[biopragmatics](https://biopragmatics.github.io/) and
#' INDRA labs programs (e.g. GILDA,
#' bioregistry). In INDRA labs terminology, GILDA grounds (predicts matches of)
#' `term` to `namespace` terms.
#'
#' @param terms Term(s) to map; as a character vector.
#' @param namespace Namespace to map terms to, as recognized by bioregistry?;
#'     as a string.
#'
#' @returns
#' List of results for each term
#'
#' @export
...
#' @inheritDotParams parse_term_mapping
#'
#' @returns
...
#'     and 1+ namespace terms (stored as specialized `ScoredMatch` python
#'     objects, as defined by GILDA; see [extract_ScoredMatch]).
