...
googlesheets4::write_sheet(do_ordo_err, ordo_gs, "DO-ORDO_not_exist")
```
...
do_ordo_deprec %>%
    dplyr::mutate(
        ordo_id = DO.utils::format_hyperlink(url = url, as = "gs", txt = ordo_id),
...
```{r curate-do_ordo_deprec, include = FALSE, eval = FALSE}
googlesheets4::write_sheet(, ordo_gs, "DO-ORDO_deprec")
```
...
googlesheets4::write_sheet(do_multi_ordo, ordo_gs, "DO-multi_ORDO_xref")
```
